...
const Footer = () => {
  return ( 
    <>
      <div className="w-full lg:h-[706px] h-full malnr bg-black">
      ...
      <span className=" lg:w-[372px] w-full lg:text-[17.15px] text-[14px] font-normal leading-[20.76px] text-grayed h-[94px] pt-[86px]">Copyright © 2023 Fund10X .All rights reserved.</span>
