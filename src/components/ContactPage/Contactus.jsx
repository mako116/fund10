...
const Contactus = () => {
    ...
    <>
     ...
     <button
       ...
       } w-[217.06px] h-[61.52px]  border-[#000] rounded-[11.44px] border-[0.86px] p-paddi gap-[5.69px] bg-gradient-to-r from-linear1 to-linear2 shadowed text-center `}>
       For Investors
     </button>
     <button
       ...
       } w-[217.06px] h-[61.52px] rounded-[11.44px] border-[0.86px] p-paddi gap-[5.69px] shadowed text-center `}>
      For Businesses
     </button>
    </div>
    </div>
    ...
    {selectedHeader === 'For_Investors' && (
        ...
        <form className='w-[634px] h-[843px]'>
        <div className="p-[50px] border-[2px] border-[#000] rounded-[20px] bg-[#fff]"> 
        <label>Full Name</label>
         <input type="text" className='my-[10px] w-[563px] h-[63px] rounded-[10px] bg-lightb text-[#000] outline-none'/>
         ...
         <select id="cars" name="cars" className='my-[10px] w-[563px] h-[63px] rounded-[10px] bg-lightb text-[#000] outline-none'>
